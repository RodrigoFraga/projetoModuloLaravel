angular.module('app.services')
    .service('ProjetoTask', ['$resource', '$filter', '$httpParamSerializer', 'appConfig', function ($resource, $filter, $httpParamSerializer, appConfig) {
        function transformData(data) {
            ...
            if (angular.isObject(data)) {
                ...
                //return appConfig.utils.transformRequest(o); TODO utilizar esse e testar
            }
            return data;
        };

        return $resource(appConfig.baseUrl + '/projeto/:id/task/:taskId', {
            id: '@id',
            taskId: '@taskId'
